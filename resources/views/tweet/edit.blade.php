      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form class="mb-6" action="{{ route('tweet.update',$tweet->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <img src="{{asset('uploads/tweets/'.$tweet->path)}}">
            <div class="flex flex-col mb-4 pt-4">
              <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="path">Image</label>
              <input class="border py-2 px-3 text-grey-darkest" type="file" name="path" id="path">
            </div>
